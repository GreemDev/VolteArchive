...
class VolteDatabase {
    ...
    fun getSettingsFor(guildId: String): GuildData = GuildData(guildId, this)
    fun getTagsFor(guildId: String): TagsRepository = TagsRepository(this, guildId)
    fun getSelfRolesFor(guildId: String): SelfRoleRepository = SelfRoleRepository(this, guildId)
