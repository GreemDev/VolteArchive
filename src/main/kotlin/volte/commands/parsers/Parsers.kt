...
object Parsers {
    ...
    //getters
    @static fun member(): VolteArgumentParser<Member?> = member
    @static fun role(): VolteArgumentParser<Role?> = role
    @static fun boolean(): VolteArgumentParser<Boolean?> = boolean
    @static fun color(): VolteArgumentParser<Color?> = color
    @static fun channel(): VolteArgumentParser<TextChannel?> = channel
}